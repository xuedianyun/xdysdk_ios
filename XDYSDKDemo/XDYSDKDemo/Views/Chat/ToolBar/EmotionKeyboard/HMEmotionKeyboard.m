...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"XDYEmoji.bundle/emoticon_keyboard_background"]];
...
//- (void)addNoti{
//    //创建一个消息对象
//    NSNotification * notice = [NSNotification notificationWithName:@"send" object:nil];
//    //发送消息
