...
//                NSString *patchStr = [documentStr stringByAppendingPathComponent:@"plistText.plist"];
        
//        NSArray *documentArr = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
//        NSString *documentStr = documentArr[0];
//        NSString *plist = [documentStr stringByAppendingPathComponent:@"EmotionIcons/default/info.plist"];
        
        
        NSString *plist = [[NSBundle mainBundle] pathForResource:@"XDYEmoji.bundle/XDYEmoji.plist" ofType:nil];
//                NSString *plist = [[NSBundle mainBundle] pathForResource:@"EmotionIcons/default/info.plist" ofType:nil];
        ...
        [_defaultEmotions makeObjectsPerformSelector:@selector(setDirectory:) withObject:@"XDYEmoji.bundle"];
    }
...
+ (NSArray *)emojiEmotions
{
    if (!_emojiEmotions) {
        ...
        [_emojiEmotions makeObjectsPerformSelector:@selector(setDirectory:) withObject:@"XDYEmoji.bundle"];
