...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [deleteButton setImage:[UIImage imageNamed:@"XDYEmoji.bundle/compose_emotion_delete"] forState:UIControlStateNormal];
        [deleteButton setImage:[UIImage imageNamed:@"XDYEmoji.bundle/compose_emotion_delete_highlighted"] forState:UIControlStateHighlighted];
