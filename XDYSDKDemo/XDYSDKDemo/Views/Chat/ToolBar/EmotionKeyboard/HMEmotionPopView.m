...
{
    return [[[NSBundle mainBundle] loadNibNamed:@"HMEmotionPopView" owner:nil options:nil] objectAtIndex:0];
}
...
{
    [[UIImage imageNamed:@"XDYEmoji.bundle/emoticon_keyboard_magnifier"] drawInRect:rect];
}
@end
