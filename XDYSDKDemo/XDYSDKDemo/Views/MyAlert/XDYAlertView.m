...
#define kButtonBottomOffset 10.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:rightBackrColor] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:leftBackrColor] forState:UIControlStateNormal];
