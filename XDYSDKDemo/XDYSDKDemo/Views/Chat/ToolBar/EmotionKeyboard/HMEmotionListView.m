...
//        pageControl.backgroundColor = [UIColor blueColor];
        [pageControl setValue:[UIImage imageNamed:@"XDYEmoji.bundle/compose_keyboard_dot_selected"] forKeyPath:@"_currentPageImage"];
        [pageControl setValue:[UIImage imageNamed:@"XDYEmoji.bundle/compose_keyboard_dot_normal"] forKeyPath:@"_pageImage"];
